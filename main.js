function getAllEvents() {
    fetch("http://eduardbrotac.com/Wordpress/wp-json/wp/v2/event?_embed")
        .then(res => res.json())
        .then(showEvents);
}

function getAllEventsByCategory(id) {
    fetch("http://eduardbrotac.com/Wordpress/wp-json/wp/v2/event?_embed&categories=" + id)
        .then(res => res.json())
        .then(showEvents);
}
...
function getAllEventsByTag(id) {
    fetch("http://eduardbrotac.com/Wordpress/wp-json/wp/v2/event?_embed&per_page=20&tags=" + id)
        .then(res => res.json())
        .then(showEvents);
}
...
function getSingleEventById(myId){
    console.log(myId);
     fetch("http://eduardbrotac.com/Wordpress/wp-json/wp/v2/event" + myId + "/?_embed")
        .then(res => res.json())
        .then(showSingleEvent);
}

function getMenu(){
    fetch("http://eduardbrotac.com/Wordpress/categories?per_page=15")
    .then(e=>e.json())
    .then(showMenu);
}
...
function getTagsMenu(){
    fetch("http://eduardbrotac.com/Wordpress/wp-json/wp/v2/tags")
    .then(e=>e.json())
    .then(showTagsMenu);
}
